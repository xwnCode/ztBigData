...
{
	/// <summary>
	/// 数据访问类:DM_BUSI_BigPatrolcarPuploadData
	/// </summary>
	public partial class DM_BUSI_BigPatrolcarPuploadData
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DM_BUSI_BigPatrolcarPuploadData"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DM_BUSI_BigPatrolcarPuploadData");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Vline.Model.DM_BUSI_BigPatrolcarPuploadData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DM_BUSI_BigPatrolcarPuploadData(");
			strSql.Append("Id,patrolcarId,taskId,img,by1,by2,by3)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vline.Model.DM_BUSI_BigPatrolcarPuploadData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DM_BUSI_BigPatrolcarPuploadData set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DM_BUSI_BigPatrolcarPuploadData ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigPatrolcarPuploadData GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,patrolcarId,taskId,img,by1,by2,by3 from DM_BUSI_BigPatrolcarPuploadData ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;

			Vline.Model.DM_BUSI_BigPatrolcarPuploadData model=new Vline.Model.DM_BUSI_BigPatrolcarPuploadData();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigPatrolcarPuploadData DataRowToModel(DataRow row)
		{
			Vline.Model.DM_BUSI_BigPatrolcarPuploadData model=new Vline.Model.DM_BUSI_BigPatrolcarPuploadData();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,patrolcarId,taskId,img,by1,by2,by3 ");
			strSql.Append(" FROM DM_BUSI_BigPatrolcarPuploadData ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DM_BUSI_BigPatrolcarPuploadData T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DM_BUSI_BigPatrolcarPuploadData";
