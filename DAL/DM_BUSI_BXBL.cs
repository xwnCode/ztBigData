...
namespace Vline.DAL
{
    ...
    /// 数据访问类:DM_BUSI_BXBL
    /// </summary>
    public partial class DM_BUSI_BXBL
    {
        public DM_BUSI_BXBL()
        { }
        #region  BasicMethod
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("Id", "DM_BUSI_BXBL");
        }

        /// <summary>
        /// 增加一条数据
        /// </summary>
        public bool Add(Vline.Model.DM_BUSI_BXBL model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into DM_BUSI_BXBL(");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Vline.Model.DM_BUSI_BXBL model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update DM_BUSI_BXBL set ");
        ...
        public bool Delete(int Id)
        {
            //该表无主键信息，请自定义主键/条件字段
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from DM_BUSI_BXBL ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
        ...
        /// 得到一个对象实体
        /// </summary>
        public Vline.Model.DM_BUSI_BXBL GetModel(int Id)
        {
            //该表无主键信息，请自定义主键/条件字段
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select Id,Updatetime,JCW,DL,BD,TX,XX,XH,Fas,Bas,By1,By2,By3 from DM_BUSI_BXBL ");
            strSql.Append(" where Id=@Id ");
            SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
            parameters[0].Value = Id;

            Vline.Model.DM_BUSI_BXBL model = new Vline.Model.DM_BUSI_BXBL();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Vline.Model.DM_BUSI_BXBL DataRowToModel(DataRow row)
        {
            Vline.Model.DM_BUSI_BXBL model = new Vline.Model.DM_BUSI_BXBL();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM DM_BUSI_BXBL ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) FROM DM_BUSI_BXBL ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from DM_BUSI_BXBL T ");
