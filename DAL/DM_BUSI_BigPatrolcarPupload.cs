...
{
	/// <summary>
	/// 数据访问类:DM_BUSI_BigPatrolcarPupload
	/// </summary>
	public partial class DM_BUSI_BigPatrolcarPupload
	{
		public DM_BUSI_BigPatrolcarPupload()
		{}
		#region  BasicMethod
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DM_BUSI_BigPatrolcarPupload"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DM_BUSI_BigPatrolcarPupload");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Vline.Model.DM_BUSI_BigPatrolcarPupload model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DM_BUSI_BigPatrolcarPupload(");
			strSql.Append("Id,cmd,timestamp,sign,data,taskId,img,by1,by2,by3)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vline.Model.DM_BUSI_BigPatrolcarPupload model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DM_BUSI_BigPatrolcarPupload set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DM_BUSI_BigPatrolcarPupload ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigPatrolcarPupload GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,cmd,timestamp,sign,data,taskId,img,by1,by2,by3 from DM_BUSI_BigPatrolcarPupload ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;

			Vline.Model.DM_BUSI_BigPatrolcarPupload model=new Vline.Model.DM_BUSI_BigPatrolcarPupload();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigPatrolcarPupload DataRowToModel(DataRow row)
		{
			Vline.Model.DM_BUSI_BigPatrolcarPupload model=new Vline.Model.DM_BUSI_BigPatrolcarPupload();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,cmd,timestamp,sign,data,taskId,img,by1,by2,by3 ");
			strSql.Append(" FROM DM_BUSI_BigPatrolcarPupload ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DM_BUSI_BigPatrolcarPupload T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DM_BUSI_BigPatrolcarPupload";
