...
{
	/// <summary>
	/// 数据访问类:DM_BUSI_BigDayProDetailsBydx
	/// </summary>
	public partial class DM_BUSI_BigDayProDetailsBydx
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DM_BUSI_BigDayProDetailsBydx"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DM_BUSI_BigDayProDetailsBydx");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Vline.Model.DM_BUSI_BigDayProDetailsBydx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DM_BUSI_BigDayProDetailsBydx(");
			strSql.Append("Updatetime,DayID,DayTotal,DayPlan,DayQualified,By1,By2,By3)");
			...
			parameters[2].Value = model.DayTotal;
			parameters[3].Value = model.DayPlan;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vline.Model.DM_BUSI_BigDayProDetailsBydx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DM_BUSI_BigDayProDetailsBydx set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DM_BUSI_BigDayProDetailsBydx ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigDayProDetailsBydx GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,Updatetime,DayID,DayTotal,DayPlan,DayQualified,By1,By2,By3 from DM_BUSI_BigDayProDetailsBydx ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			Vline.Model.DM_BUSI_BigDayProDetailsBydx model=new Vline.Model.DM_BUSI_BigDayProDetailsBydx();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigDayProDetailsBydx DataRowToModel(DataRow row)
		{
			Vline.Model.DM_BUSI_BigDayProDetailsBydx model=new Vline.Model.DM_BUSI_BigDayProDetailsBydx();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM DM_BUSI_BigDayProDetailsBydx ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DM_BUSI_BigDayProDetailsBydx T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DM_BUSI_BigDayProDetailsBydx";
