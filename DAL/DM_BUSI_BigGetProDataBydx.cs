...
{
	/// <summary>
	/// 数据访问类:DM_BUSI_BigGetProDataBydx
	/// </summary>
	public partial class DM_BUSI_BigGetProDataBydx
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DM_BUSI_BigGetProDataBydx"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DM_BUSI_BigGetProDataBydx");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Vline.Model.DM_BUSI_BigGetProDataBydx model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vline.Model.DM_BUSI_BigGetProDataBydx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DM_BUSI_BigGetProDataBydx set ");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DM_BUSI_BigGetProDataBydx ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigGetProDataBydx GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,DateofData,NameofAnsec,CrossSecNum,Span,ProjectType,BombCraOne,BombCraThr,DropperOne,DropperTwo,DropperThr,DropperFou,DropperFiv,DropperSix,DropperSev,DropperEig,DropperNin,DropperTen,DropperEle,BombCraFou,BombCraTwo,TerminalSpacing,MiddleAnchor,AnteriorFunEnd,AnteriorFunStart,By1,By2,By3 from DM_BUSI_BigGetProDataBydx ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			Vline.Model.DM_BUSI_BigGetProDataBydx model=new Vline.Model.DM_BUSI_BigGetProDataBydx();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigGetProDataBydx DataRowToModel(DataRow row)
		{
			Vline.Model.DM_BUSI_BigGetProDataBydx model=new Vline.Model.DM_BUSI_BigGetProDataBydx();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM DM_BUSI_BigGetProDataBydx ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DM_BUSI_BigGetProDataBydx T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DM_BUSI_BigGetProDataBydx";
