...
{
	/// <summary>
	/// 数据访问类:DM_BUSI_BigPatrolcarStart
	/// </summary>
	public partial class DM_BUSI_BigPatrolcarStart
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DM_BUSI_BigPatrolcarStart"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DM_BUSI_BigPatrolcarStart");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Vline.Model.DM_BUSI_BigPatrolcarStart model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DM_BUSI_BigPatrolcarStart(");
			strSql.Append("Id,cmd,timestamp,sign,data,line,direction,taskName,stations,by1,by2,by3)");
			...
			parameters[8].Value = model.stations;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vline.Model.DM_BUSI_BigPatrolcarStart model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DM_BUSI_BigPatrolcarStart set ");
			...
			parameters[4].Value = model.line;
			parameters[5].Value = model.direction;
			parameters[6].Value = model.taskName;
			parameters[7].Value = model.stations;
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DM_BUSI_BigPatrolcarStart ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigPatrolcarStart GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,cmd,timestamp,sign,data,line,direction,taskName,stations,by1,by2,by3 from DM_BUSI_BigPatrolcarStart ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;

			Vline.Model.DM_BUSI_BigPatrolcarStart model=new Vline.Model.DM_BUSI_BigPatrolcarStart();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigPatrolcarStart DataRowToModel(DataRow row)
		{
			Vline.Model.DM_BUSI_BigPatrolcarStart model=new Vline.Model.DM_BUSI_BigPatrolcarStart();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,cmd,timestamp,sign,data,line,direction,taskName,stations,by1,by2,by3 ");
			strSql.Append(" FROM DM_BUSI_BigPatrolcarStart ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DM_BUSI_BigPatrolcarStart T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DM_BUSI_BigPatrolcarStart";
