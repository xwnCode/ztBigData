...
namespace Vline.DAL
{
	...
	public partial class DM_BUSI_BigGetProData
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Vline.Model.DM_BUSI_BigGetProData model)
		{
			...
			parameters[1].Value = model.DateOfdata;
			parameters[2].Value = model.NameOfAnchor;
			parameters[3].Value = model.Number;
			parameters[4].Value = model.Type;
			parameters[5].Value = model.Abutment;
			parameters[6].Value = model.Flatears;
			parameters[7].Value = model.Cantilears;
			parameters[8].Value = model.Locatingring;
			parameters[9].Value = model.Posseat;
			parameters[10].Value = model.Windbreak;
			parameters[11].Value = model.FlatFix;
			parameters[12].Value = model.CantilArm;
			parameters[13].Value = model.Postube;
			parameters[14].Value = model.Carpalsuplon;
			parameters[15].Value = model.Carpalsupflat;
			parameters[16].Value = model.Carpalsupobl;
			parameters[17].Value = model.LocasupSupo;
			parameters[18].Value = model.LocasupArmo;
			parameters[19].Value = model.LocasupSeto;
			parameters[20].Value = model.LocasupSupt;
			parameters[21].Value = model.LocasupArmt;
			parameters[22].Value = model.LocasupSett;
			parameters[23].Value = model.PosParameters;
			parameters[24].Value = model.BaseParameters;
			parameters[25].Value = model.SusParameters;
			parameters[26].Value = model.Posslope;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vline.Model.DM_BUSI_BigGetProData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DM_BUSI_BigGetProData set ");
			strSql.Append("Id=@Id,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DM_BUSI_BigGetProData ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigGetProData GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,DateOfdata,NameOfAnchor,Number,Type,Abutment,Flatears,Cantilears,Locatingring,Posseat,Windbreak,FlatFix,CantilArm,Postube,Carpalsuplon,Carpalsupflat,Carpalsupobl,LocasupSupo,LocasupArmo,LocasupSeto,LocasupSupt,LocasupArmt,LocasupSett,PosParameters,BaseParameters,SusParameters,Posslope,By1,By2,By3 from DM_BUSI_BigGetProData ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Vline.Model.DM_BUSI_BigGetProData model=new Vline.Model.DM_BUSI_BigGetProData();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigGetProData DataRowToModel(DataRow row)
		{
			Vline.Model.DM_BUSI_BigGetProData model=new Vline.Model.DM_BUSI_BigGetProData();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM DM_BUSI_BigGetProData ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM DM_BUSI_BigGetProData ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DM_BUSI_BigGetProData T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DM_BUSI_BigGetProData";
			parameters[1].Value = "";
