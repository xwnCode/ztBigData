...
{
	/// <summary>
	/// 数据访问类:DM_BUSI_BigPatrolcarPhoto
	/// </summary>
	public partial class DM_BUSI_BigPatrolcarPhoto
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DM_BUSI_BigPatrolcarPhoto"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DM_BUSI_BigPatrolcarPhoto");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Vline.Model.DM_BUSI_BigPatrolcarPhoto model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DM_BUSI_BigPatrolcarPhoto(");
			strSql.Append("Id,cmd,timestamp,sign,data,taskId,type,shootNum,by1,by2,by3)");
			...
			parameters[7].Value = model.shootNum;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vline.Model.DM_BUSI_BigPatrolcarPhoto model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DM_BUSI_BigPatrolcarPhoto set ");
			...
			parameters[6].Value = model.shootNum;
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DM_BUSI_BigPatrolcarPhoto ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigPatrolcarPhoto GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,cmd,timestamp,sign,data,taskId,type,shootNum,by1,by2,by3 from DM_BUSI_BigPatrolcarPhoto ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;

			Vline.Model.DM_BUSI_BigPatrolcarPhoto model=new Vline.Model.DM_BUSI_BigPatrolcarPhoto();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigPatrolcarPhoto DataRowToModel(DataRow row)
		{
			Vline.Model.DM_BUSI_BigPatrolcarPhoto model=new Vline.Model.DM_BUSI_BigPatrolcarPhoto();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,cmd,timestamp,sign,data,taskId,type,shootNum,by1,by2,by3 ");
			strSql.Append(" FROM DM_BUSI_BigPatrolcarPhoto ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DM_BUSI_BigPatrolcarPhoto T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DM_BUSI_BigPatrolcarPhoto";
