...
namespace Vline.DAL
{
	...
	public partial class DM_BUSI_BigFtestEndData
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "DM_BUSI_BigFtestEndData"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from DM_BUSI_BigFtestEndData");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Vline.Model.DM_BUSI_BigFtestEndData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into DM_BUSI_BigFtestEndData(");
			strSql.Append("Id,ftestId,taskId,taskName,endStation,taskDateTime,by1,by2,by3)");
			...
			parameters[5].Value = model.taskDateTime;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vline.Model.DM_BUSI_BigFtestEndData model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DM_BUSI_BigFtestEndData set ");
			...
			parameters[4].Value = model.taskDateTime;
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DM_BUSI_BigFtestEndData ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigFtestEndData GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,ftestId,taskId,taskName,endStation,taskDateTime,by1,by2,by3 from DM_BUSI_BigFtestEndData ");
			strSql.Append(" where Id=@Id ");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)			};
			parameters[0].Value = Id;

			Vline.Model.DM_BUSI_BigFtestEndData model=new Vline.Model.DM_BUSI_BigFtestEndData();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vline.Model.DM_BUSI_BigFtestEndData DataRowToModel(DataRow row)
		{
			Vline.Model.DM_BUSI_BigFtestEndData model=new Vline.Model.DM_BUSI_BigFtestEndData();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,ftestId,taskId,taskName,endStation,taskDateTime,by1,by2,by3 ");
			strSql.Append(" FROM DM_BUSI_BigFtestEndData ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DM_BUSI_BigFtestEndData T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DM_BUSI_BigFtestEndData";
