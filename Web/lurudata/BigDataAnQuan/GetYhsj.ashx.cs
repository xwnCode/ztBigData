...
namespace Vline.Web.DispatchManageSystem.BigDataAnQuan
{
    ...
    /// GetYhsj 的摘要说明
    /// </summary>
    public class GetYhsj : IHttpHandler
    {
        Model.DM_BUSI_YHSJ m_pcd = new Model.DM_BUSI_YHSJ();
        BLL.DM_BUSI_YHSJ b_pcd = new BLL.DM_BUSI_YHSJ();
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (updated != null | inserted != null | deleted != null)
            {
                try
                {
                    List<Model.DM_BUSI_YHSJ> list_insert = inserted == null ? null : javaScriptSerializer.Deserialize<List<Model.DM_BUSI_YHSJ>>(inserted);
                    List<Model.DM_BUSI_YHSJ> list_update = updated == null ? null : javaScriptSerializer.Deserialize<List<Model.DM_BUSI_YHSJ>>(updated);
                    List<Model.DM_BUSI_YHSJ> list_delete = deleted == null ? null : javaScriptSerializer.Deserialize<List<Model.DM_BUSI_YHSJ>>(deleted);
        ...
        protected int opreate(List<Model.DM_BUSI_YHSJ> insert, List<Model.DM_BUSI_YHSJ> update, List<Model.DM_BUSI_YHSJ> delete)
        {
            ...
            if (insert != null)
            {
                foreach (Model.DM_BUSI_YHSJ m_insert in insert)
                {
                    //添加相应记录
            ...
            if (update != null)
            {
                foreach (Model.DM_BUSI_YHSJ m_update in update)
                {
                    //修改的相应记录
            ...
            if (delete != null)
            {
                foreach (Model.DM_BUSI_YHSJ m_delete in delete)
                {
                    //删除相应记录
        ...
        public string GetAddString(Vline.Model.DM_BUSI_YHSJ model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into DM_BUSI_YHSJ(");
            strSql.Append("PCSL,WCSL,WCBL,KHFS,Updatetime )");

            strSql.Append("values ('" + model.PCSL + "','" + model.WCSL + "','" + model.WCBL + "','" + model.KHFS + "','" + DateTime.Now + "') ");
        ...
        /// 获得修改一条数据的sql
        /// </summary>
        public string GetUpdateString(Vline.Model.DM_BUSI_YHSJ model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update DM_BUSI_YHSJ");
            strSql.Append(" set PCSL='" + model.PCSL + "',WCSL='" + model.WCSL + "',WCBL='" + model.WCBL + "',KHFS='" + model.KHFS + "',Updatetime='" + DateTime.Now + "' where Id=" + model.Id + " ");
            return strSql.ToString();
        }
        ...
        {
            return "delete DM_BUSI_YHSJ where Id=" + P_id + "";
        }
