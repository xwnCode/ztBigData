...
namespace Vline.Web.BigDataAnQuan
{
    ...
    /// NewGetYhsl 的摘要说明
    /// </summary>
    public class NewGetYhsl : IHttpHandler
    {
        BLL.DM_BUSI_YHSL b_YearPlanType = new BLL.DM_BUSI_YHSL();
        Model.DM_BUSI_YHSL m_YearPlanType = new Model.DM_BUSI_YHSL();
        ...
        private string AddType(Dictionary<string, object> dictionary)
        {
            try
            {
                ...
                m_YearPlanType.YIJI =Convert.ToInt32( dictionary["YIJI"].ToString());
                m_YearPlanType.ERJI = Convert.ToInt32(dictionary["ERJI"].ToString());
                m_YearPlanType.SANJI = Convert.ToInt32(dictionary["SANJI"].ToString());
                m_YearPlanType.SIJI = Convert.ToInt32(dictionary["SIJI"].ToString());
