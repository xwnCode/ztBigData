...
namespace Vline.Web.BigDataWuZi
{

    /// <summary>
    /// GetDhqk 的摘要说明
    /// </summary>
    public class GetDhqk : IHttpHandler
    {
        BLL.DM_BUSI_DHQK b_YearPlanType = new BLL.DM_BUSI_DHQK();
        Model.DM_BUSI_DHQK m_YearPlanType = new Model.DM_BUSI_DHQK();
        ...
        private string AddType(Dictionary<string, object> dictionary)
        {
            try
            {
                ...
                m_YearPlanType.JCW =dictionary["JCW"].ToString();
                m_YearPlanType.DL = dictionary["DL"].ToString();
                m_YearPlanType.BD = dictionary["BD"].ToString();
                m_YearPlanType.TX = dictionary["TX"].ToString();

                m_YearPlanType.XX = dictionary["XX"].ToString();
                m_YearPlanType.XH = dictionary["XH"].ToString();
                m_YearPlanType.Fas = dictionary["Fas"].ToString();
                m_YearPlanType.Bas = dictionary["Bas"].ToString();
