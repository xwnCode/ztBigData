...
namespace Vline.Web.DispatchManageSystem.BigDataWuZi
{
    ...
    /// GetJqwzyj 的摘要说明
    /// </summary>
    public class GetJqwzyj : IHttpHandler
    {
        BLL.DM_BUSI_JQWZYJ b_YearPlanType = new BLL.DM_BUSI_JQWZYJ();
        Model.DM_BUSI_JQWZYJ m_YearPlanType = new Model.DM_BUSI_JQWZYJ();
        ...
        private string AddType(Dictionary<string, object> dictionary)
        {
            try
            {
                ...
                m_YearPlanType.JQWZ = dictionary["JQWZ"].ToString();
