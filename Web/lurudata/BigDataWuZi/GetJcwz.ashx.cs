...
namespace Vline.Web.DispatchManageSystem.BigDataWuZi
{
    ...
    /// GetJcwz 的摘要说明
    /// </summary>
    public class GetJcwz : IHttpHandler
    {
        BLL.DM_BUSI_JCWZ b_YearPlanType = new BLL.DM_BUSI_JCWZ();
        Model.DM_BUSI_JCWZ m_YearPlanType = new Model.DM_BUSI_JCWZ();
        ...
        private string AddType(Dictionary<string, object> dictionary)
        {
            try
            {
                ...
                m_YearPlanType.NAME = dictionary["NAME"].ToString();
                m_YearPlanType.XH = dictionary["XH"].ToString();
                m_YearPlanType.DW = dictionary["DW"].ToString();
                m_YearPlanType.JCSL = dictionary["JCSL"].ToString();
