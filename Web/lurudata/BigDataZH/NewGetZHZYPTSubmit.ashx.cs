...
{
    /// <summary>
    /// NewGetZHZYPTSubmit 的摘要说明
    /// </summary>
    public class NewGetZHZYPTSubmit : IHttpHandler
    {
        ...
        public string GetData()
        {
            try
            {
                DataSet dsMessage = b_YearPlanType.GetAllList("Worktype='钻孔作业'");
        ...
        private string AddType(Dictionary<string, object> dictionary)
        {
            try
            {
                ...
                m_YearPlanType.Ks = float.Parse(dictionary["Ks"].ToString());
                m_YearPlanType.Kj = float.Parse(dictionary["Kj"].ToString());
                m_YearPlanType.Kjj = float.Parse(dictionary["Kjj"].ToString());
                m_YearPlanType.Kzquantity = Convert.ToInt32(dictionary["Kzquantity"].ToString());
